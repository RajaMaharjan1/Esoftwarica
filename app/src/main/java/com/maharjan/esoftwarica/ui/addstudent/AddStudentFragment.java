package com.maharjan.esoftwarica.ui.addstudent;
...
public class AddStudentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        sname = view.findViewById(R.id.etName);
        saddress = view.findViewById(R.id.etAddaddress);
        sage = view.findViewById(R.id.etAddage);
        sname = view.findViewById(R.id.etName);
        genderRG = view.findViewById(R.id.Gender);
